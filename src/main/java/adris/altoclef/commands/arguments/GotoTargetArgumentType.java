...
public class GotoTargetArgumentType implements ArgumentType<GotoTarget> {
    	private static final GotoTargetArgumentType INSTANCE = new GotoTargetArgumentType();
        private static final Collection<String> EXAMPLES = List.of("[x y z dimension]/[x z dimension]/[y dimension]/[dimension]/[x y z]/[x z]/[y]");
	    static final DynamicCommandExceptionType INVALID_NUM_OF_COORD_ARGS = new DynamicCommandExceptionType(numbers -> Text.literal("Unexpected number of integers passed to coordinate: " + numbers));
	    ...
	    public static GotoTarget get(CommandContext<?> context) {
	        return context.getArgument("gotoTarget", GotoTarget.class);
	    }
...
//	        }
	        ...
	        switch (numbers.size()) {
	            ...
	            default ->
	                    throw INVALID_NUM_OF_COORD_ARGS.create(numbers.size());
	        };
